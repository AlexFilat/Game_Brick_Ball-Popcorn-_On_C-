...
public:
    ...
    void Init();
    void Set_Current_Level(char Level[AsConfig::AsConfig::Level_Height][AsConfig::AsConfig::Level_Width]);
    void Act();
    void Draw(HDC hdc, RECT& paint_area);

    //AActive_Brick Active_Brick;
    static char Level_01[AsConfig::AsConfig::Level_Height][AsConfig::AsConfig::Level_Width];
    static char Test_Level[AsConfig::AsConfig::Level_Height][AsConfig::AsConfig::Level_Width];
private:
